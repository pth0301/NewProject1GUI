...
public class CreateNewSharedChannels {
    public CreateNewSharedChannels(String teamId, String displayName, String description, String membershipType, Owner owner) {
        ...
        try {
            ...
            if (teamResponse.statusCode() == 202) {
